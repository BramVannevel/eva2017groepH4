...
public class RestoListFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Restaurant r1 = new Restaurant("de gouden fazant",R.drawable.testafbvegan,"","0499280469","hoogstraat 36, gent");
        Restaurant r2 = new Restaurant("de zilveren wortel",R.drawable.testafbvegan2,"","053803317","Rodelijvekensstraat 1, gent");
